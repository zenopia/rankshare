...
import { Heart, List, Users, Share2, Menu } from "lucide-react";
    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <footer className="border-t">
        <div className="container flex h-14 items-center justify-between">
          <p className="text-sm text-muted-foreground">© 2024 Favely. All rights reserved.</p>
          <nav className="flex items-center space-x-4 text-sm">
            <Link href="/terms" className="text-muted-foreground hover:text-[#801CCC]">
              Terms
            </Link>
            <Link href="/privacy" className="text-muted-foreground hover:text-[#801CCC]">
              Privacy
            </Link>
          </nav>
        </div>
